...
* results somewhat underwhelming for cross validation, but both models showed some support that a multi species model can improve precision of estimates (removal model in particular)

* 

* migration strategy mattering less

* talk about Common Redpoll removal modelling
