...
If our prediction is true, then we would expect to have predicted cue rates and EDRs be similar to true cue rates and EDRs obtained from modelling with data.
...
The mean modelled difference in cue rate was $-1.56 \times 10^{-3}$, indicating that estimates of cue rate from a multi-species model may be slightly less than estimates of cue rate from a single-species model.
