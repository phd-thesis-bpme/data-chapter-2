...
\par The cross validation revealed that multi-species model had better predictive capacity for more species (200 out of 316) than the single-species model (99 out of 316).
Seventeen out of 316 species showed no better predictive capacity with either model.
Mean overall difference in log predictive density was $4.78 \times 10^{-6}$.
...
\par (NEEDS UPDATING) The cross validation revealed that the multi-species model tended to have slightly more support than the single-species model in terms of predicting EDR.
...
hat is, in the absence of any data (or with very little data in the case of Kirtland’s Warbler), the estimated EDR of Bicknell’s Thrush and Kirtland’s Warbler was similar to those of other Thrushes and Warblers, respectively, but with departures from overall mean based on specific traits.
